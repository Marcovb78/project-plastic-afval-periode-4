    ...
    <div class="rounded-t-3xl w-full bg-white">
        <div class="p-4">
            <div class="flex flex-column justify-center items-center relative">
                <div class="mx-10 {{ \Request::route()->getName() == 'events.map' ? 'relative bottom-10 drop-shadow-lg' : null }}">
                ...
                <div class="mx-10 {{ \Request::route()->getName() == 'feed.show' ? 'relative bottom-10 drop-shadow-lg' : null }}">
                ...
                <div class="mx-10 {{ str(\Request::route()->getName())->contains('news') ? 'relative bottom-10 drop-shadow-lg' : null }}">
