    ...
    <div class="rounded-t-3xl w-full bg-gray-200">
        <div class="p-4">
            <div class="flex flex-column justify-center items-center relative">
                <div class="mx-10 {{ \Request::route()->getName() == 'events.map' ? 'relative bottom-10' : null }}">
                ...
                <div class="mx-10 {{ \Request::route()->getName() == 'feed.show' ? 'relative bottom-10' : null }}">
                ...
                <div class="mx-10 {{ \Request::route()->getName() == 'news.index' ? 'relative bottom-10' : null }}">
                    <a href="{{ route('feed.show') }}">
                        <div class="rounded-full bg-white p-3">
